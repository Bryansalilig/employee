...
<div class="page-content fade-in-up" style="margin-left:20px;">
   <div class="ibox ibox-info">
      <div class="ibox-head">
         <div class="ibox-title">Performance Evaluation</div>
         <div class="pull-right">
            ...
            @endif
            @if($is_leader > 0)
            <a href="{{ route('team-evaluation') }}" class="btn bg-primary text-white"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp; Team Evaluation</a>
            @endif
            @if(Auth::user()->isAdmin() || $is_leader > 0)
            <a href="{{ route('evaluation.create') }}" class="btn bg-ebony text-white"><i class="fa fa-edit"></i>&nbsp;&nbsp; File Performance Evaluation</a>
            @endif
         </div>
      </div>
