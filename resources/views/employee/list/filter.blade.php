<div class="ibox ibox-info mb-0 mt-4 collapsed-mode">
  ...
  <div class="ibox-body p-3" style="{{ $display ? '' : 'display: none;' }}">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-12">
        <a href="{{ url('employees') }}" class="btn btn-default btn-block"><i class="fa fa-filter"></i> Clear Filter</a>
      </div>
    </div>
    @else
    <div class="row">
      ...
      <div class="col-md-3 col-12 form-group">
        <a href="{{ url('separated-employees') }}" class="btn btn-default btn-block"><i class="fa fa-filter"></i> Clear Filter</a>
      </div>
    </div>
    @endif
  </div>
