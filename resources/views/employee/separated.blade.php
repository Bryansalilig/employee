...
<style type="text/css">
    ...
    .rounded-circle-container:hover {
        ...
        /* Apply a box shadow to brighten the border on hover */
    }
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel-heading">
                    <div class="col-md-12">
                        <i class="fa fa-home text-success"></i> / Employees > <span style="color:#3498db">Separated
                            Employees</span><br><br>
                        <ul class="alphabet-search">
                            <li>
                                ...
                                <form>
                                    ...
                                    <input type="text" placeholder="Search by name" id="search_employee" name="keyword"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="emp-profile">
                                                        <div class="row d-flex">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a class="fullname"
                                                                    href="{{ url("employee_info/{$employee->slug}") }}">{{ $employee->fullname() }}</a>
                                                                <h5 style="font-size:15px;font-weight:450">
                                                                    <?= $employee->position_name ?></h5>
                                                                <p class="employee-account"
                                                                    style="font-size:12px;font-weight:500">
                                                                    {{ $employee->team_name }}
                                                                    {{ isset($employee->account) ? '- ' . $employee->account->account_name : '' }}
                                                                </p>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <p>
                                                                    <span class="fa fa-id-card"
                                                                        title="Employee ID">&nbsp;&nbsp;</span>
                                                                    <span class="employee-description"
                                                                        style="font-size:15px"><?= $employee->eid ?></span>
                                                                </p>
                                                                <p class="employee-email-description">
                                                                    <span class="fa fa-envelope"
                                                                        title="Email Address">&nbsp;&nbsp;</span>
                                                                    <span class="employee-description employee-email"
                                                                        style="color:#0c59a2;font-size:15px"
                                  ...
                                  ?>
                                                                <h5>
                                                                    <span class="fa fa-phone"
                                                                        title="Extension Number">&nbsp;&nbsp;</span>
                                                                    <span
                                                                        class="employee-description"><?= $employee->ext ?></span>
                                                                </h5>
                                                                <?php
                              }
                                  ...
                                  ?>
                                                                <h5>
                                                                    <span class="fa fa-mobile"
                                                                        title="Phone Name">&nbsp;&nbsp;</span>
                                                                    <span class="employee-description"
                                                                        style="font-size:15px"><?= $employee->alias ?></span>
                                                                </h5>
                                                                <?php
                              }
         ?>
                                                            ...
                                                            <div class="col-md-3">
                                                                <p>
                                                                    ...
                                                                    <span class="name-format"
                                                                        style="color:#777;font-size:14px">Immediate
                                                                        Superior: </span>
                                                                    <span
                                                                        style="font-size:14px"><?= $employee->supervisor_name ?></span>
                                                                </p>
                                                                <p>
                                                                    <span class="fa fa-user" title="Manager"></span>
                                                                    <span class="name-format"
                                                                        style="color:#777;font-size:14px">Manager: </span>
                                                                    <span
                                                                        style="font-size:14px"><?= $employee->manager_name ?></span>
                                                                </p>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <div class="options">
                                                                    ...
                                                                    <a href="<?= url("employees/{$employee->slug}/reactivate")
            ...
            $(function() {
                ...
                $('#employee-card .col-md-3').each(function(key) {
                    ...
                    if (name_h != name.height()) {
                        ...
                        $('#employee-card .col-md-3[data-row="' + row + '"]').find('h4.card-title').addClass(
                            'text-align-center').height(h);
                    }

                    if (position_h != position.height()) {
                        var h = (position_h > position.height()) ? position_h : position.height();

                        $('#employee-card .col-md-3[data-row="' + row + '"]').find('h6.card-position').addClass(
                            'text-align-center').height(h);
                    }
                    ...
                    if (team_h != team.height()) {
                        ...
                        $('#employee-card .col-md-3[data-row="' + row + '"]').find('h6.card-team').addClass(
                            'text-align-center').height(h);
                    }
                });
                ...
                $('.delete_btn').click(function() {
                    ...
                    $('#messageModal .delete_form').attr('action', "<?= url('employee_info') ?>/" + $(this)
                        .attr("data-id"));
                });
