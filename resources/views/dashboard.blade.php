    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-success color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">{{ $new_hires }}</h2>
                    <div class="m-b-5">NEW HIRES</div><i class="fa fa-user-plus widget-stat-icon"></i>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-danger color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">{{ $new_attrition }}</h2>
                    <div class="m-b-5">ATTRITIONS</div><i class="fa fa-user-times widget-stat-icon"></i>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-info color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">{{ $new_leave }}</h2>
                    <div class="m-b-5">LEAVE REQUEST</div><i class="fa fa-calendar-o widget-stat-icon"></i>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-warning color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">{{ $new_overtime + $new_undertime }}</h2>
                    <div class="m-b-5">OT/UT REQUEST</div><i class="fa fa-clock-o widget-stat-icon"></i>
                    <div><?= widgetPercentage($new_overtime + $new_undertime, $old_overtime + $old_undertime) ?></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="ibox-body">
                    ...
                    <table class="table table-striped m-t-20 visitors-table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img class="m-r-10" src="img/flags/us.png" />USA</td>
                                <td>755</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="img/flags/Canada.png" />Canada</td>
                                <td>700</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="img/flags/India.png" />India</td>
                                <td>410</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="img/flags/Australia.png" />Australia</td>
                                <td>304</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="img/flags/Singapore.png" />Singapore</td>
                                <td>203</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="img/flags/uk.png" />UK</td>
                                <td>202</td>
                                <td>
                                    <div class="progress">
                            ...
                            <tr>
                                <td>
                                    <img class="m-r-10" src="img/flags/UAE.png" />UAE</td>
                                <td>180</td>
                                <td>
                                    <div class="progress">
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <ul class="media-list media-list-divider m-0">
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img src="img/image.jpg" width="50px;" />
                            </a>
                            <div class="media-body">
...
@section('script')
    <!-- PAGE LEVEL SCRIPTS-->
    <script src="<?= URL::to('js/scripts/dashboard_1_demo.js') ?>" type="text/javascript"></script>
@endsection