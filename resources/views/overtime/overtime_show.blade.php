                ...
                <div class="row">
                  <div class="col-md-12" style="border-right: 1px solid #eee;">
                    <ul class="media-list media-list-divider m-0 row">
                      <li class="media col-6 px-2 flex-wrap" data-emp-id="3828"><h6 class="text-info m-b-10 w-100"><i class="fa fa-check-circle" aria-hidden="true"></i> <?= ($overtime->status == 'DECLINED' && $overtime->declined_by_superior == 'YES') ? 'Declined by' : 'Recommending Approval' ?>:</h6>
                        <div class="media-img">
